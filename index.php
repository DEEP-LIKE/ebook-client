        ...
        <div class="form-container">
            ...
            <div style="margin-top: 20px; padding: 15px; background: #f0f8ff; border-radius: 5px; border-left: 4px solid #007cba;">
                ...
                <ol>
                    ...
                    <li>📁 <strong>Crea todas las carpetas base</strong> desde basesite</li>
                ...
                <p><strong>Nota:</strong> El sistema requiere que el API esté disponible para obtener la información actualizada de los sitios.</p>
            </div>
